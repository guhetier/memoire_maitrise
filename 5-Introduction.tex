...
présentée dans la partie \ref{sec:Theme1}. Cette transformation construit le
produit entre le code du système et l'automate de Büchi associé à la propriété
LTL à vérifier, exprimé en C. Nous évaluons ensuite les performances obtenues
