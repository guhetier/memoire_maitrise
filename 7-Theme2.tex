...
\item
  ...
  modèle de la formule ou non, quelleque soit l'extension
...
propositions atomique : il ne faut actualiser la valeur de la proposition
...
Le code de ces outils et une série de tests sont disponibles sur Github, à
l'adresse
