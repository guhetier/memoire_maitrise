...
model-checker logiciel. L'utilisation de variables locales et de positions est
rendue possible dans les propositions atomiques. Ce formalisme de
spécification englobe ainsi les assertions et les proposition LTL classiquement
utilisées. Il permet ainsi de surmonter les limitations des assertions et de
\ac{LTL} que nous avons présentées.
