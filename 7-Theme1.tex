...
par la variable \texttt{energy\_stored}. Celle-ci est décrémentée dans une
...
\texttt{energy\_stored} des threads \texttt{battery1} et
\texttt{battery2} ne valent pas \texttt{0} simultanément. Mais les
variables \texttt{energy\_stored} sont des variables locales : la
