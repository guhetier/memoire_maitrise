...
Spécifier l'absence de data-races dans ce programme à l'aide d'assertion n'est
...
Les model-checkers logiciels supportant LTL restreignent en généralement les
...
mais ce n'est pas le cas pour d'autres propriétés (d'exclusions mutuelles ou non).
...
que, quelleque soit l'exécution menant à l'état \(p\), le pointeur d'exécution a
...
Des travaux autour de la prise en charge des variables locales ont été réalisés,
