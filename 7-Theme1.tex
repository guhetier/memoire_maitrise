...
L'un des cas où identifier une variable dépends d'une notion dynamique a lieu
...
Nous avons donc utilisé des marqueurs. Nous avons choisis des labels, puisqu'ils
...
autour du model-checker Divine\cite{Divine}. Ils sont présenté dans
\cite{Divine_LTL}.
